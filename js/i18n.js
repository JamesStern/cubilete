...
const DICT = {
  en: {
    ...
    'tie.title': 'Tie!', 'tie.again': 'Tied again!', 'tie.text': '{names} both hold <b>{hand}</b>. One roll each, all five dice — the higher hand takes the round.',
    'tie.textMany': '{names} all hold <b>{hand}</b>. One roll each, all five dice — the higher hand takes the round.', 'tie.textAgain': '{names} tie once more. Same again: one roll each.',
    'tie.btn': 'Roll off', 'tie.waiting': 'waiting', 'tie.section': 'Desempate', 'tie.round': 'roll-off {n}',
  ...
  es: {
    ...
    'tie.title': '¡Empate!', 'tie.again': '¡Otro empate!', 'tie.text': '{names} tienen <b>{hand}</b>. Una tirada cada uno, con los cinco dados: la mano más alta se lleva la ronda.',
    'tie.textMany': '{names} tienen <b>{hand}</b>. Una tirada cada uno, con los cinco dados: la mano más alta se lleva la ronda.', 'tie.textAgain': '{names} vuelven a empatar. Lo mismo: una tirada cada uno.',
    'tie.btn': 'Desempatar', 'tie.waiting': 'espera', 'tie.section': 'Desempate', 'tie.round': 'desempate {n}',
    'rotate': 'Pon el teléfono en vertical',
